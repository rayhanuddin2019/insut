 ...
 */
   ...
   $blog_sidebar    = quomodo_market_option('blog_sidebar',1);
   $blog_two_column = quomodo_market_option('blog_two_column',0);
        ...
        <div class="row">
              ...
              ?>
                    ...
                    <div class="<?php echo esc_attr($column);?>">
                       <div class="single-blog-area mt-30">
                          <?php while ( have_posts() ) : the_post(); ?>
                                  ...
                                  <?php
                                    ...
                                    quomodo_market_post_nav();
                                    comments_template(); 
                                    quomodo_market_set_postview();
